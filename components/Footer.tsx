...
export default function Footer() {
  return (
    <footer className="border-offwhite/10 border-t bg-black">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="text-magenta hover:text-magenta/80 transition-colors">
              <Logo variant="full" className="mb-4 h-8 w-auto" />
            </Link>
            <Text variant="small" className="text-offwhite/70 max-w-sm">
        ...
        {/* Bottom section */}
        <div className="border-offwhite/10 mt-8 border-t pt-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <div className="flex space-x-6">
              {footerLinks.legal.map((link) => (
                <Link
                  key={link.name}
                  href={link.href}
                  className="text-offwhite/70 hover:text-magenta text-xs transition-colors"
                >
                  {link.name}
                </Link>
              ))}
            ...
            <div className="flex items-center space-x-6">
              <Link
                ...
                className="text-offwhite/70 hover:text-magenta transition-colors"
                aria-label="GitHub"
              >
