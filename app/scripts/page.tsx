...
export const metadata: Metadata = {
  ...
  description: 'Production-ready automation scripts and tools for DevOps, cloud infrastructure, and AI operations.',
};
...
const scriptCategories = [
  {
    ...
    count: 24,
    popular: [
      { name: 'k8s-auto-scaler', stars: 1250, description: 'AI-powered autoscaling for Kubernetes' },
  ...
  },
  {
    ...
    count: 18,
    popular: [
      { name: 'multi-cloud-deploy', stars: 2100, description: 'Deploy to AWS, GCP, Azure seamlessly' },
  ...
  },
  {
    ...
    popular: [
      ...
      { name: 'crossplane-templates', stars: 1100, description: 'Cloud-native infrastructure templates' },
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-600/20 via-navy to-black" />
        <div className="relative mx-auto max-w-7xl text-center">
          <Heading as="h1" variant="h1" color="gradient" className="mb-6">
            Scripts Marketplace
          </Heading>
          <Text variant="lead" className="max-w-3xl mx-auto mb-8">
            Production-ready automation scripts built by experts. Save weeks of development 
            time with battle-tested solutions for Kubernetes, CI/CD, and cloud infrastructure.
          </Text>
      ...
      {/* Stats */}
      <section className="py-12 px-4 sm:px-6 lg:px-8 border-y border-offwhite/10">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-magenta">88+</div>
              <Text variant="small" className="text-offwhite/70">Premium Scripts</Text>
            </div>
            <div>
              <div className="text-3xl font-bold text-magenta">15K+</div>
              <Text variant="small" className="text-offwhite/70">GitHub Stars</Text>
            </div>
            <div>
              <div className="text-3xl font-bold text-magenta">2.5K+</div>
              <Text variant="small" className="text-offwhite/70">Active Users</Text>
            </div>
            <div>
              <div className="text-3xl font-bold text-magenta">99.9%</div>
              <Text variant="small" className="text-offwhite/70">Success Rate</Text>
            </div>
          </div>
        </div>
      </section>
                    ...
                    >
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-1">
                          ...
                          <div className="flex items-center gap-1 text-sm text-offwhite/60">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <Text variant="lead" className="max-w-2xl mx-auto">
              Start with our open source scripts, upgrade when you need premium features and support.
            </Text>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingTiers.map((tier) => (
              <div
                key={tier.name}
                className={`relative bg-gradient-to-br from-offwhite/5 to-offwhite/0 border rounded-2xl p-8 ${
                  tier.popular 
              ...
              >
                {tier.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-magenta text-navy text-sm font-semibold rounded-full">
                    Most Popular
                  </div>
                )}
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="flex items-baseline justify-center gap-1">
                    ...
                    {tier.period && (
                      <span className="text-offwhite/60">{tier.period}</span>
                    )}
                  </div>
                </div>
