        ...
        <div className="mx-auto max-w-4xl space-y-12">
          ...
          <div>
            ...
            <Text variant="body" className="text-offwhite/80 mb-4">
              By accessing or using the services provided by Astro Intelligence Inc ("Company," "we," "us," 
              or "our"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any 
          ...
          <div>
            ...
            <ul className="space-y-2 text-offwhite/80">
              <li className="flex items-start gap-2">
                <span className="text-magenta mt-1">•</span>
                <Text variant="body">Be at least 18 years of age or have legal parental consent</Text>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-magenta mt-1">•</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-magenta mt-1">•</span>
                <Text variant="body">Accept responsibility for all activities under your account</Text>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-magenta mt-1">•</span>
          ...
          <div>
            ...
            <Text variant="body" className="text-offwhite/80 mb-4">
              Payment is due according to the terms in your service agreement. Late payments may incur 
              fees and result in service suspension.
            </Text>
            ...
            <Text variant="body" className="text-offwhite/80">
              Refund policies are as specified in your service agreement. Generally, we offer a 30-day 
          ...
          <div>
            ...
            <Text variant="body" className="text-offwhite/80 mb-4">
              All content, features, and functionality of our services are owned by Astro Intelligence Inc 
            ...
            <Text variant="body" className="text-offwhite/80 mb-4">
              ...
              us a license to use, modify, and display that content as necessary to provide our services.
            </Text>
            ...
            <Text variant="body" className="text-offwhite/80">
              Some of our scripts and tools are provided under open source licenses. The applicable license 
              terms will be clearly indicated.
            </Text>
          </div>
          ...
          <div>
            ...
            <Text variant="body" className="text-offwhite/80">
              ...
              during the course of our business relationship. This obligation survives termination of 
              these Terms.
            </Text>
          </div>
          ...
          <div>
            ...
            <Text variant="body" className="text-offwhite/80 uppercase font-semibold mb-4">
              To the maximum extent permitted by law, Astro Intelligence Inc shall not be liable for any 
          ...
          <div>
            ...
            <Text variant="body" className="text-offwhite/80">
              You agree to indemnify and hold harmless Astro Intelligence Inc, its officers, directors, 
          ...
          <div>
            ...
            <Text variant="body" className="text-offwhite/80">
              ...
              changes via email or through our services. Continued use after changes constitutes acceptance 
              of the new Terms.
            </Text>
          </div>
          ...
          <div>
            ...
            <div className="bg-gradient-to-br from-offwhite/5 to-offwhite/0 border border-offwhite/10 rounded-2xl p-6">
              <Text variant="body" className="text-offwhite/80">
                ...
                Legal Department<br />
                Email: legal@astrointelligence.com<br />
          ...
          <div>
            ...
            <Text variant="body" className="text-offwhite/80">
              These Terms constitute the entire agreement between you and Astro Intelligence Inc regarding 
