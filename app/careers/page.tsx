...
export const metadata: Metadata = {
  ...
  description: 'Join our team of innovators building the future of AI and cloud infrastructure. Explore open positions and our unique culture.',
};
    ...
    positions: [
      {
        ...
        requirements: ['5+ years Kubernetes experience', 'Platform engineering expertise', 'Go or Python proficiency'],
      },
      {
      ...
      },
      {
        ...
        requirements: ['GitOps workflows', 'Cloud platforms (AWS/GCP/Azure)', 'Infrastructure as Code'],
      },
    ],
  },
  {
    ...
    positions: [
      {
        ...
        requirements: ['5+ years B2B SaaS PM', 'Technical background', 'Enterprise software experience'],
      },
      {
        title: 'UX Designer',
        location: 'Remote (Global)',
    ...
    positions: [
      {
        ...
        requirements: ['5+ years enterprise sales', 'Cloud/DevOps industry knowledge', '$1M+ quota achievement'],
      },
      {
        ...
        requirements: ['Technical writing skills', 'Developer marketing experience', 'SEO expertise'],
      },
    ],
  },
];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl text-center">
          ...
          <Text variant="lead" className="max-w-3xl mx-auto mb-8">
            Join a team of passionate innovators working on the most challenging 
            problems in AI and cloud infrastructure. Your best work starts here.
          </Text>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <div className="space-y-4 text-offwhite/80">
                ...
                <Text variant="body">
                  We believe in giving our team members the tools, freedom, and support they need 
                  to do their best work. Whether you're architecting a solution for millions of users 
          ...
          <div className="bg-gradient-to-br from-offwhite/10 to-offwhite/5 rounded-2xl p-12 text-center">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit) => (
              <div 
                key={benefit.title}
                className="bg-gradient-to-br from-offwhite/5 to-offwhite/0 border border-offwhite/10 rounded-2xl p-6"
              >
      ...
      <section id="positions" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="space-y-12">
            {openPositions.map((category) => (
              <div key={category.category}>
                <Heading as="h3" variant="h3" className="mb-6 text-magenta">
                  {category.category}
                </Heading>
                ...
                <div className="space-y-6">
                  {category.positions.map((position) => (
                    <div
                      key={position.title}
                      className="bg-gradient-to-br from-offwhite/5 to-offwhite/0 border border-offwhite/10 rounded-2xl p-8 hover:border-magenta/50 transition-colors"
                    >
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-4 text-sm text-offwhite/60 mb-4">
          ...
          <div className="mt-12 p-8 bg-gradient-to-r from-magenta/10 to-purple-600/10 rounded-2xl text-center">
            ...
            {[
              {
                ...
                description: 'We review every application carefully and respond within 3-5 business days.',
              },
              {
                step: '2',
                title: 'Initial Conversation',
                description: '30-minute chat with our recruiting team to discuss your background and interests.',
              },
              {
                step: '3',
                title: 'Technical Assessment',
                description: 'Role-specific assessment or take-home project (compensated for your time).',
              },
              {
                step: '4',
                title: 'Team Interviews',
                description: 'Meet your potential teammates and dive deep into technical and cultural fit.',
              },
              {
                step: '5',
                title: 'Final Decision',
                description: 'We make decisions quickly and provide detailed feedback regardless of outcome.',
              },
            ].map((phase) => (
