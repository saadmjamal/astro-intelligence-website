...
images:
  [
    { 'src': '/images/case-studies/fintech/dashboard-overview.svg', 'alt': 'NeoBank Dashboard Overview', 'caption': 'The new unified dashboard showing real-time metrics and AI insights' },
    { 'src': '/images/case-studies/fintech/architecture-diagram.svg', 'alt': 'Microservices Architecture', 'caption': 'High-level architecture showing the transition from monolith to microservices' },
    { 'src': '/images/case-studies/fintech/deployment-pipeline.svg', 'alt': 'CI/CD Pipeline', 'caption': 'Automated deployment pipeline with AI-powered testing' },
    { 'src': '/images/case-studies/fintech/monitoring-dashboard.svg', 'alt': 'Monitoring Dashboard', 'caption': 'Real-time monitoring showing 99.99% uptime achievement' },
  ]
beforeAfter:
  {
    'before': { 'src': '/images/case-studies/fintech/legacy-architecture.svg', 'alt': 'Legacy Monolith Architecture', 'caption': 'Single monolithic application handling all services' },
    'after': { 'src': '/images/case-studies/fintech/modern-architecture.svg', 'alt': 'Modern Microservices Architecture', 'caption': 'Distributed microservices with AI orchestration' },
  }
architectureDiagrams:
  [
    { 'src': '/images/case-studies/fintech/system-design.svg', 'alt': 'System Design', 'caption': 'Complete system architecture', 'description': 'Shows the full system design including API gateway, service mesh, and data flow' },
    { 'src': '/images/case-studies/fintech/data-flow.svg', 'alt': 'Data Flow Diagram', 'caption': 'Real-time data processing pipeline', 'description': 'Illustrates how data flows through the system with event-driven architecture' },
  ]
---
